    ...
    public class ArticuloNegocio
    {
        ...
        public List<Articulo> listar()
        {
            ...
            try
            {
                ...
                comando.CommandText = "select Codigo, Nombre, A.Descripcion, C.Descripcion as Tipo, M.Descripcion as Marca, ImagenUrl, Precio, A.IdCategoria, A.IdMarca, A.Id from ARTICULOS A, CATEGORIAS C, MARCAS M  where A.IdCategoria = C.Id and A.IdMarca = M.Id";
